export function Whats({ fill }) {
    return (
      <svg 
        xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 448 512" 
        width="20"  // Ajusta el tamaño aquí
        height="20" // Ajusta el tamaño aquí
        fill={fill || "currentColor"} // Esto asegura que se pueda cambiar el color
      >
